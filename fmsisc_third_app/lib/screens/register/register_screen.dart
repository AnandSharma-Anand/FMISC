        ...
        body: FutureBuilder(
          ...
          builder:
              (context, snapshot) => Container(
                ...
                width: Get.width,
                decoration: const BoxDecoration(image: DecorationImage(image: AssetImage('assets/master_background.png'), fit: BoxFit.fill)),
                child: SafeArea(
                  child: Form(
                    ...
                    child: ListView(
                      ...
                      children: <Widget>[
                        Center(child: Image.asset('assets/up_govt.png', width: Get.width / 3)),
                        // precacheImage(),
                        Center(child: Image.asset('assets/logo.png', width: Get.width / 2.6)),
